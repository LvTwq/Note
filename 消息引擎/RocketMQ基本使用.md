...
![image](https://note.youdao.com/yws/api/personal/file/C349F7DDB0C34B64B8FE4BB9D76C7C01?method=download&shareKey=4b9b3c91393345d33b7418837447acea)
...
![image](https://note.youdao.com/yws/api/personal/file/4C6BEA145F304ACAA2FA63D079B6E3EC?method=download&shareKey=44c1215087b38661b8c158279132438c)

使用消息队列解耦合，系统的耦合性就会提高了。比如物流系统发生故障，需要几分钟才能来修复，在这段时间内，物流系统要处理的数据被缓存到消息队列中，用户的下单操作正常完成。当物流系统回复后，补充处理存在消息队列中的订单消息即可，终端系统感知不到物流系统发生过几分钟故障。

![](https://note.youdao.com/yws/api/personal/file/593A79F37F0C46CF8A0EC9590436BD23?method=download&shareKey=ce6d485736885d55c536f9673cc20bd5)

* 流量削峰

![](https://note.youdao.com/yws/api/personal/file/A5110291C089442687B0CB334B1C8277?method=download&shareKey=2d93d8f60560fd9efc0f14097ca33bfc)

应用系统如果遇到系统请求流量的瞬间猛增，有可能会将系统压垮。有了消息队列可以将大量请求缓存起来，分散到很长一段时间处理，这样可以大大提到系统的稳定性和用户体验。

![](https://note.youdao.com/yws/api/personal/file/DD28C5E97E8E451DB37AD2E5E868F43B?method=download&shareKey=ea92118c354bda954f5122910847ab66)
...
![](https://note.youdao.com/yws/api/personal/file/16D7E5DB41C645A4BEBD9CFECD7BC4C7?method=download&shareKey=808e3121d515f63a97fb4c1988225792)

通过消息队列可以让数据在多个系统更加之间进行流通。数据的产生方不需要关心谁来使用数据，只需要将数据发送到消息队列，数据使用方直接在消息队列中直接获取数据即可

![](https://note.youdao.com/yws/api/personal/file/02870D1B29B7454BACFED6B00131BAB0?method=download&shareKey=60077b5253059d226f54a7408c14ef95)
...
![](https://note.youdao.com/yws/api/personal/file/6C4C85D677104ABDAB868D8AE332567A?method=download&shareKey=eb9d42f421b8d9f91e6d064db65ca784)
...
![](https://note.youdao.com/yws/api/personal/file/9D9FD48E5D504B99A329D477FB6FBC25?method=download&shareKey=8b225dbdc8ecdd670406868e9fbe0177)
